...
being around 100\,ms. This relatively low value sets the demand for a fast network interaction
...
the lagging operation of desktop programs has a negative impact on the user experience,
and with video conferencing or other graphics-intensive applications,
the utilization of resources and latency requirements are very similar to computer games.
...
below 1ms for internal backend communication
