...
\end{itemize}
% TODO: Mention hardware-accelerated framebuffer protocols like \cite{hanimplementation} \cite{darcy2022latency}
% TODO: More scientific papers: \cite{di2021network} \cite{carrascosa2022cloud}
...
and empowering users to choose their own tailored solutions.
...
and involves the direct exchange of raw data with object instances.
